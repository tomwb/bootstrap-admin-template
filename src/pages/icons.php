        ...
        <div class="card-body">
            <div class="widget-body" id="all-icons-demo">
              ...
              <div class="row mb-3">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-shekel"></i> fa-shekel <span class="text-color-theme">(alias)</span>
                </div>
  
                <div class="col-6 col-lg-4">
                  <i class="fa fa-sheqel"></i> fa-sheqel <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-soccer-ball-o"></i> fa-soccer-ball-o <span class="text-color-theme">(alias)</span>
                </div>
              ...
              <h3>70 new icons was introduced in 4.1</h3>
              <hr>

              <div class="row mb-3">

                <div class="col-6 col-lg-4">
                  <i class="fa fa-automobile"></i> fa-automobile <span class="text-color-theme">(alias)</span>
                </div>

                <div class="col-6 col-lg-4">
                  <i class="fa fa-bank"></i> fa-bank <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-cab"></i> fa-cab <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-file-movie-o"></i> fa-file-movie-o <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-file-photo-o"></i> fa-file-photo-o <span class="text-color-theme">(alias)</span>
                </div>

                <div class="col-6 col-lg-4">
                  <i class="fa fa-file-picture-o"></i> fa-file-picture-o <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-file-sound-o"></i> fa-file-sound-o <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-file-zip-o"></i> fa-file-zip-o <span class="text-color-theme">(alias)</span>
                </div>

                <div class="col-6 col-lg-4">
                  <i class="fa fa-ge"></i> fa-ge <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-institution"></i> fa-institution <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-life-bouy"></i> fa-life-bouy <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-life-saver"></i> fa-life-saver <span class="text-color-theme">(alias)</span>
                </div>

                <div class="col-6 col-lg-4">
                  <i class="fa fa-mortar-board"></i> fa-mortar-board <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-pied-piper-square"></i> fa-pied-piper-square <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-ra"></i> fa-ra <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-send"></i> fa-send <span class="text-color-theme">(alias)</span>
                </div>

                <div class="col-6 col-lg-4">
                  <i class="fa fa-send-o"></i> fa-send-o <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-support"></i> fa-support <span class="text-color-theme">(alias)</span>
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-wechat"></i> fa-wechat <span class="text-color-theme">(alias)</span>
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-dashboard"></i> fa-dashboard <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-edit"></i> fa-edit <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-flash"></i> fa-flash <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-gear"></i> fa-gear <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-gears"></i> fa-gears <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-legal"></i> fa-legal <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-mail-forward"></i> fa-mail-forward <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-mail-reply"></i> fa-mail-reply <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-mobile-phone"></i> fa-mobile-phone <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-sort-down"></i> fa-sort-down <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-sort-up"></i> fa-sort-up <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-star-half-empty"></i> fa-star-half-empty <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-star-half-full"></i> fa-star-half-full <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-toggle-down"></i> fa-toggle-down <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-toggle-left"></i> fa-toggle-left <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-toggle-right"></i> fa-toggle-right <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-toggle-up"></i> fa-toggle-up <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-unsorted"></i> fa-unsorted <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-warning"></i> fa-warning <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
              ...
              <div class="row mb-3">
                <div class="col-6 col-lg-4">
                  <i class="fa fa-bitcoin"></i> fa-bitcoin <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-btc"></i> fa-btc
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-cny"></i> fa-cny <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-dollar"></i> fa-dollar <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-eur"></i> fa-eur
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-euro"></i> fa-euro <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-rmb"></i> fa-rmb <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-rouble"></i> fa-rouble <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-rub"></i> fa-rub
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-ruble"></i> fa-ruble <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-rupee"></i> fa-rupee <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-try"></i> fa-try
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-turkish-lira"></i> fa-turkish-lira <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-usd"></i> fa-usd
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-won"></i> fa-won <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-yen"></i> fa-yen <span class="text-color-theme">(alias)</span>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-chain"></i> fa-chain <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-copy"></i> fa-copy <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-cut"></i> fa-cut <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-dedent"></i> fa-dedent <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-eraser"></i> fa-eraser
                </div>
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-paste"></i> fa-paste <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-repeat"></i> fa-repeat
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-rotate-left"></i> fa-rotate-left <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-rotate-right"></i> fa-rotate-right <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                  <i class="fa fa-save"></i> fa-save <span class="text-color-theme">(alias)</span>
                </div>
                <div class="col-6 col-lg-4">
                ...
                <div class="col-6 col-lg-4">
                  <i class="fa fa-unlink"></i> fa-unlink <span class="text-color-theme">(alias)</span>
                </div>
              </div>
